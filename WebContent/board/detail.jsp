...
<script>
   ...
   function commentWriteForm(id,username,content,createDate,userProfile){
       ...
       comment_list += "<button onClick='commentDelete("+id+")' class='btn-reply text-uppercase' style='display: inline-block; float: left; margin-right: 10px; height: 35px;'><i class='fa fa-trash' style='font-size: 21px; margin-top: 5px;'></i></button>";
       comment_list += "<button onClick='replyForm("+id+")' class='btn-reply text-uppercase' style='display: inline-block; float: left; margin-right: 10px; height: 35px;'><i class='fa fa-edit' style='font-size: 18px; margin-top: 5px;'></i></button></div></div>";
       ...
       comment_list += "<div class='thumb'> <img src='"+userProfile+"' alt='' width=70px height=70px style='border-radius:50%'> </div> ";
